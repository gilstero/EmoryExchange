  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-6 text-[#0c2b9c] text-center mb-4 p-12">
        ...
        <p className="block">Eagle Exchange is Emory's premier freelancing platform, allowing Emory students to list their goods and services on an Emory-exclusive site.</p>
      </div>
      <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-6 text-green-800 text-center mb-4">
        <div className="flex flex-col justify-center p-4 w-[300px]">
          <h3 className="font-bold text-2xl mb-2">Safe and Secure</h3>
          <p>
        ...
        <div className="flex flex-col justify-center p-4 w-[300px]">
          <h3 className="font-bold text-2xl mb-2">Wide Variety of Services</h3>
          <p>
        ...
        <div className="flex flex-col justify-center p-4 w-[300px]">
          <h3 className="font-bold text-2xl mb-2">Campus Community</h3>
          <p>
